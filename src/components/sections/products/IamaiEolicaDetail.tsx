...
export default function IamaiEolicaDetail() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="bg-gradient-to-br from-imgenia-navy/5 via-white to-imgenia-blue/5 py-20 pt-32">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl font-bold text-gray-900 mb-4">Endesa · IAMAI Eólica</h1>
              <p className="text-2xl text-imgenia-navy font-medium mb-6">
